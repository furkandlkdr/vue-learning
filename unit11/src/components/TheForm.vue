<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="formData.userName" @blur="validateInput"/>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-news" name="interest" type="checkbox" value="new" v-model="formData.interest" />
        <label for="interest-news">News</label>
      </div>
      <div>
        <input id="interest-tutorials" name="interest" type="checkbox" value="tutorials" v-model="formData.interest" />
        <label for="interest-tutorials">Tutorials</label>
      </div>
      <div>
        <input id="interest-nothing" name="interest" type="checkbox" value="nothing" v-model="formData.interest" />
